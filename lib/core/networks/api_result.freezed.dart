...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiErrorHandler errorHndler) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(ApiErrorHandler errorHndler)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({ApiErrorHandler errorHndler});
}
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  final ApiErrorHandler errorHndler;
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final ApiErrorHandler errorHndler) = _$FailureImpl<T>;

  ApiErrorHandler get errorHndler;
  @JsonKey(ignore: true)
  _$$FailureImplCopyWith<T, _$FailureImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
